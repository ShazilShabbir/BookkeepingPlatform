  ...
  return (
    <div className="min-h-screen bg-surface-50 flex items-center justify-center px-4 py-8">
      <div className="text-center max-w-md w-full">
        <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-red-50 text-red-500 flex items-center justify-center mx-auto mb-5 sm:mb-6">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold text-surface-900 mb-2">500</h1>
        <p className="text-base sm:text-lg text-surface-500 mb-3 sm:mb-4">Something went wrong</p>

...
// Extracted core encoder - no rendering, no GIF, no canvas
// Only the matrix generation is kept.
...
var qrcode = function() {
  ...
  var qrAlphaNum = function(data) {
    ...
    var getCode = function(c) {
      ...
      switch (c) { case ' ': return 36; case '$': return 37; case '%': return 38; case '*': return 39; case '+': return 40; case '-': return 41; case '.': return 42; case '/': return 43; case ':': return 44; }
  ...
  var qr8BitByte = function(data) {
    ...
    var _bytes = qrcode.stringToBytes ? qrcode.stringToBytes(data) : (function(s) { var b = []; for (var i = 0; i < s.length; i++) b.push(s.charCodeAt(i) & 0xff); return b; })(data);
    var _this = {};
    _this.getMode = function() { return _mode; };
  ...
  qrcode.stringToBytesFuncs = { 'default' : function(s) { var bytes = []; for (var i = 0; i < s.length; i += 1) bytes.push(s.charCodeAt(i) & 0xff); return bytes; } };

...
export default memo(function CategoryChart({ data, title = 'Expenses by Category', onCategoryClick }: { data: CategoryStat[]; title?: string; onCategoryClick?: (category: string) => void }) {
  if (data.length === 0) {
    return (
      <Card padding="md">
